...
import logouni from '../Images/LogoInternConnect.png'; // Asegúrate de ajustar la ruta a tu imagen
    ...
    <div className="registro-container">
      ...
      <form onSubmit={handleSubmit} className="registro-form">
        <div style={{ textAlign: 'center', marginBottom: '20px' }}>
          <img src={logouni} alt="Logo Uni" style={{ width: '100px', marginTop: '20px' }} />
        </div>
